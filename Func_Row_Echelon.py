...
def echelon_maker():
    # Linear Algebra Matrix With Maximum 6x6 Dimensions Solved By Row Echelon Form
    print('')
    print("Linear Algebra Matrix With Maximum 6x6 Dimensions Solved By Row Echelon Form")
    print('')
    print("This is an algorithm to solve Linear Equation Systems by using Row Echelon Form.")
    ...
    while column_number < column_count and row_number < row_count:
        ...
        if containers[row_number][column_number] == 1:
            print('Column {} / Row {} is already 1. \n'.format(column_number + 1, row_number + 1))
        ...
        if row_number != row_count - 1:
            print('Making Below C{}R{} All 0'.format(column_number + 1, row_number + 1))
            for i in range(row_number, row_count):
